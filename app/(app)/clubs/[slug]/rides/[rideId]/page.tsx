...
const STATUS_STYLES: Record<string, { bg: string; border: string; color: string }> = {
  proposed:  { bg: 'color-mix(in srgb, var(--amber), white 80%)', border: 'var(--amber)',  color: 'color-mix(in srgb, var(--amber), black 40%)' },
  confirmed: { bg: 'color-mix(in srgb, var(--mint),  white 80%)', border: 'var(--mint)',   color: 'color-mix(in srgb, var(--mint),  black 40%)' },
  completed: { bg: 'color-mix(in srgb, var(--accent),white 80%)', border: 'var(--accent)', color: 'color-mix(in srgb, var(--accent),black 40%)' },
};
    ...
    <div className="fixed inset-0 top-16 z-10 flex" style={{ backgroundColor: 'var(--paper)' }}>
      ...
      >
        ...
        >
          ...
          <div className="mt-2">
            <span
              className="badge-neutral capitalize text-xs"
              style={{ backgroundColor: statusStyle.bg, borderColor: statusStyle.border, color: statusStyle.color }}
            >
              {ride.status}
            </span>
          </div>
